...
function InsomniacAction({ onAction }: Props) {
  ...
  return (
    <div style={styles.container}>
      <h2 style={{ ...styles.title, color: "#2a8a4a" }}>INSOMNIAC</h2>
      <div style={styles.divider} />
      <p style={styles.description}>You wake up to check if your role has changed during the night.</p>
      <button style={submitted ? styles.buttonDisabled : styles.button} onClick={handleAction} disabled={submitted}>
        {submitted ? "CHECKING..." : "CHECK MY ROLE"}
      </button>
    </div>
  );
}
